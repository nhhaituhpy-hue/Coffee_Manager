...
import { TrendingUp, PiggyBank, Target, Settings2, PlusCircle, ArrowRightCircle, Download, Filter, CheckCircle2, X, Trash2, Lock } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 gap-6">
        ...
        >
          ...
          <div className="flex items-baseline gap-2">
            <span className="text-4xl font-bold text-primary font-financial">{currentBalance.toLocaleString('vi-VN')}</span>
            <span className="text-lg font-bold text-primary">đ</span>
          </div>
      ...
      <div className="bg-surface border border-outline-variant rounded-2xl shadow-sm overflow-hidden">
        <div className="px-6 py-6 border-b border-outline-variant flex justify-between items-center bg-surface-container relative">
           ...
           <div className="flex gap-2">
              ...
              <button className="flex items-center gap-2 text-xs font-bold px-4 py-2 border border-outline-variant rounded-lg hover:bg-surface-container-high bg-surface transition-colors">
                          ...
                          <td className="px-8 py-5">
                             <div className="flex items-center gap-3">
                                <div className={`p-2 rounded-full ${
                                   tx.type === 'WITHDRAW' ? 'bg-tertiary/10 text-tertiary' : 
            ...
            >
              ...
              <div className="space-y-4">
                <div>
                  ...
                  />
                  {parseInt(withdrawAmount.replace(/\D/g, '') || '0') > currentBalance && (
                    <p className="text-error text-xs font-bold mt-1">Số tiền rút không được vượt quá số dư hiện tại!</p>
                  )}
                </div>
                <div>
              ...
              <div className="mt-8 flex gap-3">
                ...
                <button 
                  ...
                  disabled={!withdrawAmount || parseInt(withdrawAmount.replace(/\D/g, '')) > currentBalance || !withdrawReason.trim()}
